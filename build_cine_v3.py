...
if hero and ex_hero:
    ...
    # Remove badges entirely since they are not in the example
    badges_wrapper = hero.find(class_='hero-badges')
    if badges_wrapper:
        badges_wrapper.decompose()
    ...
    if ex_img:
        src = ".." + ex_img['src']
        # Remove extra slides, keep only one with the correct image
...
# Section 2 (Tu sala puede convertirse...)
